/**
 * GET /api/crm/dashboard?workspaceId=...
 * Returns aggregated metrics for the dashboard:
 *  - revenue (won deals sum)
 *  - pipelineValue (open deals sum)
 *  - dealCount, leadCount, contactCount, taskCount
...
import { ok, requireWorkspace, fail } from '@/lib/api'
